...
with keep.running():  # Keeps code running for a long time without interruption
    ...
    input_folder = "//Users/u2260235/Documents/Y3 Project/prob_workflow_241111/1_source"
    output_folder = "//Users/u2260235/Documents/Y3 Project/segment_nucleus_250214/1_nucleus_masks"
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".tif") or filename.endswith(".tiff"):
            ...
            output_filename = os.path.splitext(filename)[0] + "_nmasks.tiff"
